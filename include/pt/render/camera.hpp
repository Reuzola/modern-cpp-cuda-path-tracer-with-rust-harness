...
public:
    ...
    [[nodiscard]] Ray generate_ray(int i, int j, const Vec3& pixel_offset) const { // pixel_offset -> [-0.5, 0.5]²
        ...
        const Point3 origin = defocus_enabled_ ? defocus_disk_sample() : center_;
